...
export class CredentialsController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista paginada de credenciamentos',
  })
  async findAll(
  ...
  @ApiResponse({
    status: 429,
    description: 'Muitas requisições - limite: 10/min',
  })
  async validateCNPJ(
    @Param('id', ParseUUIDPipe) id: string,
    @CurrentUser() user: AuthUser,
  ...
  @ApiResponse({
    status: 400,
    description: 'Status não permite aprovação ou não requer revisão manual',
  })
  @ApiResponse({
    status: 404,
    description: 'Credenciamento ou análise não encontrado',
  })
  ...
  @ApiResponse({
    status: 400,
    description: 'Status não permite rejeição ou não requer revisão manual',
  })
  @ApiResponse({
    status: 404,
    description: 'Credenciamento ou análise não encontrado',
  ...
  async rejectCompliance(
    ...
    return this.complianceService.rejectCompliance(
      id,
      dto.reason,
      dto.notes,
      user,
  ...
  @ApiOperation({
    summary: 'Listar credenciamentos pendentes de revisão manual',
  })
  ...
  @ApiResponse({
    status: 429,
    description: 'Muitas requisições - limite: 5/min',
  })
