...
describe('InvitationService', () => {
    ...
    describe('sendInvitation', () => {
        ...
        it('should create invitation record even on send failure', async () => {
            ...
            expect(mockPrismaService.credentialInvitation.create).toHaveBeenCalledWith({
    ...
    describe('validateInvitationToken', () => {
        ...
        it('should update openedAt on first validation', async () => {
            ...
            expect(mockPrismaService.credentialInvitation.update).toHaveBeenCalledWith({
                where: { id: 'inv-123' },
                data: expect.objectContaining({
        ...
        it('should not update openedAt if already opened', async () => {
            ...
            expect(mockPrismaService.credentialInvitation.update).not.toHaveBeenCalled();
        });
    });
    ...
    describe('resendInvitation', () => {
        ...
        it('should throw BadRequestException if no previous invitation', async () => {
            ...
            await expect(service.resendInvitation('cred-123', mockUser)).rejects.toThrow(
                BadRequestException,
            );
        });
