...
describe('ChatService', () => {
    ...
    describe('getMessages', () => {
        it('should return messages with pagination', async () => {
            const mockMessages = [
                { id: 'msg-1', content: 'Message 1', read: false, createdAt: new Date('2026-01-01') },
                { id: 'msg-2', content: 'Message 2', read: true, createdAt: new Date('2026-01-02') },
            ];
            ...
            const result = await service.getMessages('order-1', 'user-1', { limit: 50 });
        ...
        it('should handle cursor-based pagination', async () => {
            const mockMessages = [
                { id: 'msg-3', content: 'Message 3', createdAt: new Date('2026-01-03') },
            ];
        ...
        it('should indicate hasMore when there are more messages', async () => {
            ...
            expect(result.nextCursor).toBe(result.messages[result.messages.length - 1].id);
        });
    });
    ...
    describe('acceptProposal', () => {
        ...
        it('should throw NotFoundException if message not found', async () => {
            ...
            await expect(
                service.acceptProposal('msg-999', 'user-1')
            ).rejects.toThrow(NotFoundException);
        });
