...
import { UserRole, SupplierDocumentType, SupplierDocumentStatus } from '@prisma/client';
...
export class SupplierDocumentsController {
    ...
    async createWithFile(
        ...
        return this.supplierDocumentsService.createWithFile(dto, uploadedFile, userId);
    }
